...
func (m *Transaction) validateExternalMetadata(formats strfmt.Registry) error {
...
func (m *Transaction) contextValidateExternalMetadata(ctx context.Context, formats strfmt.Registry) error {
