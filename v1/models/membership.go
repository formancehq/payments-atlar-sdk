...
type Membership struct {
	...
	// programmatic access secret generation possible
	ProgrammaticAccessSecretGenerationPossible bool `json:"programmaticAccessSecretGenerationPossible,omitempty"`
	...
	// role owner
	RoleOwner bool `json:"roleOwner,omitempty"`
	...
	WebAuthnCredentials bool `json:"webAuthnCredentials,omitempty"`
}
