...
var regexMap = map[string]ogenregex.Regexp{
	"^[A-Z]{2,2}$":               ogenregex.MustCompile("^[A-Z]{2,2}$"),
	"^[A-Z]{3,3}$":               ogenregex.MustCompile("^[A-Z]{3,3}$"),
	"^[a-zA-Z0-9._\\-+=]{1,64}$": ogenregex.MustCompile("^[a-zA-Z0-9._\\-+=]{1,64}$"),
	"^[a-zA-Z0-9\\-]{1,256}$":    ogenregex.MustCompile("^[a-zA-Z0-9\\-]{1,256}$"),
	"^external:[a-zA-Z0-9._\\-+=]{1,64}$|^[a-zA-Z0-9\\-]{1,256}$": ogenregex.MustCompile("^external:[a-zA-Z0-9._\\-+=]{1,64}$|^[a-zA-Z0-9\\-]{1,256}$"),
	"^version:\\d{1,4}$": ogenregex.MustCompile("^version:\\d{1,4}$"),
}
var (
